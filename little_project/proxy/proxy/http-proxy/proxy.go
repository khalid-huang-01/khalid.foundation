...
// 这个是在目标机器的agent接收到来自原始目标机器的req之后向真正的server发起访问的处理方式
...
func main() {
	...
	flag.Parse()
	*destPeer = "/ip4/127.0.0.1/tcp/12000/ipfs/QmesaLSPDTw7d8MHEWdbp51P1FDVrurAti5vb5rPsUR8FK"
