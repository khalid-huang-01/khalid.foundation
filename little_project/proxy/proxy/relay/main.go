...
func run() {
	// Create three libp2p hosts, enable relay1.go client capabilities on all
	// of them.
	...
	// Tell the host to relay1.go connections for other peers (The ability to *use*
	// a relay1.go vs the ability to *be* a relay1.go)
	...
	// Creates a relay1.go address to h3 using h2 as the relay1.go
