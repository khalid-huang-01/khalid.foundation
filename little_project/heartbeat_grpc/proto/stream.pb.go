...
func (x *StreamMsg) GetNode() string {
	if x != nil {
		return x.Node
	}
	return ""
...
func (x *StreamMsg) GetType() string {
	if x != nil {
		return x.Type
	}
	return ""
...
func (x *StreamMsg) GetNumber() string {
	if x != nil {
		return x.Number
	}
	return ""
...
var file_proto_stream_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x05, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4b, 0x0a, 0x09, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x6f, 0x64, 0x65,
	...
	0x52, 0x06, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x32, 0x45, 0x0a, 0x06, 0x53, 0x74, 0x72, 0x65,
	0x61, 0x6d, 0x12, 0x3b, 0x0a, 0x0f, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x53,
	0x74, 0x72, 0x65, 0x61, 0x6d, 0x12, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x53, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x1a, 0x10, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e,
	0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x4d, 0x73, 0x67, 0x22, 0x00, 0x28, 0x01, 0x30, 0x01, 0x42,
...
var file_proto_stream_proto_goTypes = []interface{}{
	(*StreamMsg)(nil), // 0: proto.StreamMsg
}
var file_proto_stream_proto_depIdxs = []int32{
	0, // 0: proto.Stream.HeartbeatStream:input_type -> proto.StreamMsg
	0, // 1: proto.Stream.HeartbeatStream:output_type -> proto.StreamMsg
